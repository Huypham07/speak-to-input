      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            />
            {touched.fund_name && errors.fund_name && (
              <p className="text-sm text-red-500">{errors.fund_name}</p>
            )}
          </div>
          <div className="space-y-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              className={touched.target_amount && errors.target_amount ? "border-red-500 focus-visible:ring-red-500" : ""}
            />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              className={touched.initial_amount && errors.initial_amount ? "border-red-500 focus-visible:ring-red-500" : ""}
            />
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={touched.monthly_contribution && errors.monthly_contribution ? "border-red-500 focus-visible:ring-red-500" : ""}
            />
